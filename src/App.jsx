...
const DetailPage = ({ surahNum, onBack, onNavigate }) => {
  ...
  // Reset pivot highlight on surah change
  useEffect(() => { setPivotLit(false); }, [surahNum]);
...
/* ═══════════════════════════════════════════════════════════════════════
   SECTION 12: APP SHELL — URL-based routing via History API
   ═══════════════════════════════════════════════════════════════════ */
function getRoute() {
  ...
  if (surahMatch) {
    ...
    if (num >= 1 && num <= 114) return { view: 'detail', surahNum: num };
  }
  return { view: 'landing' };
}
...
export default function App() {
  ...
  return (
    ...
    <div className="maraya-root">
      {route.view === "landing" && <LandingPage onExplore={() => navigate('/explore')} onSelect={handleSelectFrom('/explore')} />}
      ...
      {route.view === "detail" && route.surahNum && <DetailPage key={route.surahNum} surahNum={route.surahNum} onBack={() => navigate(prevPath.current)} onNavigate={(n) => navigate(`/surah/${n}`)} />}
